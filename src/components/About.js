        ...
        return (
            <div id="About" className="sections aos-item">
                ...
                data-aos-delay="2000">My name is Cristina and I'm a <b className="coloredText">
                    solutions-driven full stack developer</b> based in the San Francisco Bay Area.</h2><h2 className="aboutOpening2" data-aos="fade-right" data-aos-easing="ease-in-sine" 
                data-aos-delay="2000">I have a passion for <b className="coloredText">responsive 
